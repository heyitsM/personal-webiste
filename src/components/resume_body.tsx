export default function ResumeBody() {
    return (
        <div className="text-l text-indigo-800 dark:text-indigo-500 rounded-lg p-4 h-fit border-2 border-indigo-900/50 hover:border-indigo-900/20 backdrop-blur-sm bg-gradient-to-b from-indigo-950/20 via-violet-950/20 to-purple-950/20 dark:hover:from-purple-950/50 dark:hover:via-violet-950/50 dark:hover:to-indigo-950/50 hover:from-purple-950/10 hover:via-violet-950/10 hover:to-indigo-950/10" >
            I am a passionate and aspiring software engineer, in the process of completing a B.S. in Computer Science at 
            <a href="https://www.jhu.edu/" className="hover:text-violet-800 dark:hover:text-violet-600"> <b>Johns Hopkins University</b></a>. 
            I have prior experience in backend and some frontend development. With knowledge of 
            ...
            <br />
            <br />
            I have development experience, both through school, an internship with <a href="https://tech.seo-usa.org/" className="hover:text-violet-800 dark:hover:text-violet-600"><b> SEO Tech Developer </b></a>
